...
def test_entity_graph_merge():
    from src.common.types import Entity, EntityGraph, Relationship
    ...
    g2.add_relationship(
        Relationship(source_id="a", target_id="b", relationship_type="subsidiary_of")
    )
    g1.merge(g2)
...
def test_orchestrator_prompts():
    from src.orchestrator.prompts import DECOMPOSITION_PROMPT, SYSTEM_PROMPT
