...
const KNOWN_FNS = ['waitFor', 'wait', 'scrollToEl', 'hl', 'unhl', 'clickEl', 'expand', 'navigate', 'type', 'press'];
const SEL_REQUIRED = ['waitFor', 'scrollToEl', 'hl', 'clickEl', 'expand', 'navigate', 'type'];
