...
(function () {
  ...
  function ensureStyles() {
    ...
    s.textContent = `
      .vn-hl {
        outline: 2px solid #5b9bd4 !important;
        outline-offset: 4px;
        border-radius: 0;
        position: relative;
        z-index: 9998;
      ...
      @keyframes vn-pulse {
        0%   { box-shadow: 0 0 0 0   rgba(91,155,212,0.55); }
        60%  { box-shadow: 0 0 0 14px rgba(91,155,212,0); }
        100% { box-shadow: 0 0 0 0   rgba(91,155,212,0); }
      }
      .vn-hl-pulse {
